...
static void mark_frame_free(struct pmm_state *pmm,
                            uint64_t frame) {
...
static void mark_frame_used(struct pmm_state *pmm,
                            uint64_t frame) {
    if (frame >= pmm->frame_count) {
        return;
    }
...
static void mark_range_free(struct pmm_state *pmm,
                            uint64_t base,
                            uint64_t length) {
    uint64_t end;
...
static void mark_range_used(struct pmm_state *pmm,
                            uint64_t base,
                            uint64_t length) {
    uint64_t end;
